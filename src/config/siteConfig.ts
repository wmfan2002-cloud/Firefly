...
export const siteConfig: SiteConfig = {
	title: "FCS and DT",
	subtitle: "旅游记录",
	site_url: "https://blog.fcsaidt.de",
	description:
		"这是樊春松与董彤的旅行日记，记录我们一起走过的山川湖海、城市街巷。从浪漫的欧洲小镇到壮丽的自然风光，每一次出发都是爱的延续。在这里，我们用文字和照片珍藏旅途中的美好瞬间，分享沿途的风景、美食与故事。愿这些记忆成为我们爱情旅程中最珍贵的纪念。",
	keywords: [
		"旅游",
		"旅行日记",
		"情侣旅行",
	...
	navbarTitle: "FCS and DT", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
	...
	backgroundWallpaper: {
		...
		src: {
			// 桌面背景图片
			desktop: "/assets/images/fcsdt-3.png",
			// 移动背景图片
			mobile: "/assets/images/fcsdt-2.webp",
		},
